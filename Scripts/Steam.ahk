...
; Retrive Files =========================================================================================
    ...
    FileAppend,     %Start%`n%StartPrevious%`n%End%`n%EndPrevious%`n, %Temp%\Steam_temp.temp
...
; Replace  ============================================================================================
    ...
    Clean := StrReplace(Clean, " exited.", "")
    Clean := StrReplace(Clean, " state changed : Fully Installed,App Running,", "")
