...
Gui, Add, Picture, x0 y0 w1000 h1000 , J:\Fini\Autohotkey\Time Tracker GUI BG 03.jpg      ;Background
...
; Featured =========================================================================================
    ...
    Gui, Add, Text, x102 y356 w390 h20 vSteamPath,
...
; Retreive User Options ============================================================================
    ...
    ; Riot
        ...
        GuiControl,, RiotPath, %Riot% WIP                                                         ; WIP
    ...
    ; Origin
        ...
        GuiControl,, OriginPath, %Origin% WIP                                                         ; WIP




Gui, Show,, Time Tracker by Aonne. alpha_v0.25
...
Featured = %Steam%%Epic%%GOG%%Minecraft%%Nvidia%%Battlenet%
